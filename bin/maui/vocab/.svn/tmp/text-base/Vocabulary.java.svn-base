...
public class Vocabulary implements Serializable {
	 ...
	 * @throws Exception 
	 * */
	public Vocabulary(String vocabularyName, String vocabularyFormat)
			throws Exception {

		this.vocabularyFormat = vocabularyFormat;

		if (vocabularyFormat.equals("skos")) {
			SKOS = new File("data/vocabularies/" + vocabularyName + ".rdf");
			if (!SKOS.exists())
				throw new Exception("File data/vocabularies/" + vocabularyName
						+ ".rdf does not exist.");

		} else if (vocabularyFormat.equals("text")) {
			EN = new File("data/vocabularies/" + vocabularyName + ".en");
			USE = new File("data/vocabularies/" + vocabularyName + ".use");
			REL = new File("data/vocabularies/" + vocabularyName + ".rel");
